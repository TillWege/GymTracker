export default function Privacy() {
  return (
    <>
      ...
      <p>
        Your privacy is important to us. It is the policy of GymTracker to
        ...
        across our website,{" "}
        <a href="https://gym.wegetill.de">Gym.wegetill.de</a>, and other sites
        we own and operate.
      </p>
      <p>
      ...
      <p>This policy is effective as of 2 September 2023. </p>
      <p>Last updated: 2 September 2023 </p>
      ...
      <ul>
        <li>to provide you with our core features and services</li>
        <li>
      ...
      <p>
        ...
        organizations (known as “data processors”). Gymtracker, located at the
      ...
      <p>
        ...
        will delete your personal information within 1 days of the deletion of
